    ...
    <div className="flex flex-col lg:flex-row items-center justify-between px-6 lg:px-20 py-16 bg-gray-50 relative overflow-hidden">
      ...
      <div className="relative w-full lg:w-1/2 flex justify-center items-end mb-10 lg:mb-0 min-h-[400px]">
        ...
        <img
          src={imgTop}
          alt="Worker Main"
          className="absolute bottom-10 left-20 w-82 h-[26rem] object-cover rounded-br-[80px] rounded-tl-[20px] shadow-xl z-10"
        />
      ...
      <div className="w-full  lg:w-1/2 text-center lg:text-left">
        <h2 className="text-3xl lg:text-4xl font-bold text-black mb-2 flex  items-center gap-2">
          About Us
            ...
            <div className="flex justify-center lg:justify-end">
              {team.map((img, idx) => (
                <img
                  ...
                  src={img}
                  alt={`Expert ${idx + 1}`}
                  className={`w-22 h-22 rounded-full object-cover border-2 border-white shadow-md ${idx !== 0 ? "-ml-4" : ""
                    }`}
                />
              ))}
            </div>
